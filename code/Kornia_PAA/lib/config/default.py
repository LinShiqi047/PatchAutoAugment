...
def update_config(cfg, args):
    ...
    if args.is_leinao:
        ...
        cfg.MODEL.IMAGE_SIZE = (args.IMAGE_SIZE, args.IMAGE_SIZE)
        cfg.TRAIN.END_EPOCH = args.EPOCHS
        cfg.TRAIN.BATCH_SIZE_PER_GPU = args.BATCH_SIZE
        cfg.TEST.BATCH_SIZE_PER_GPU = args.BATCH_SIZE
        cfg.RLPROB = args.RLPROB

        if args.DATASET == 'cub':
            cfg.DATASET.ROOT = '/data/linshiqi047lsq/CUBdataset'
        elif args.DATASET == 'dog':
            cfg.DATASET.ROOT = '/data/linshiqi047lsq/stanforddog_lsq'
        else:
            raise('no dataset root in leinao ! ')
